...
public class RedmineJSONParser {
	...
	public static Issue parseIssue(JSONObject content) throws JSONException {
		...
		final JSONObject parentIssueObject = JsonInput.getObjectOrNull(content, "parent");
		...
		final JSONObject priorityObject = JsonInput.getObjectOrNull(content, "priority");
		...
		final JSONObject statusObject = JsonInput.getObjectOrNull(content, "status");
		...
		result.setJournals(JsonInput.getListOrEmpty(content, "journals", JOURNAL_PARSER));
		result.getAttachments().addAll(JsonInput.getListOrEmpty(content, "attachments", ATTACHMENT_PARSER));
		result.getRelations().addAll(JsonInput.getListOrEmpty(content, "relations", RELATION_PARSER));
		...
		result.setChangesets(JsonInput.getListOrEmpty(content, "changesets", CHANGESET_PARSER));
		result.setWatchers(JsonInput.getListOrEmpty(content, "watchers", WATCHER_PARSER));
		result.setChildren(JsonInput.getListOrEmpty(content, "children", ISSUE_PARSER));
		return result;
	}
	...
	public static User parseUser(JSONObject content) throws JSONException {
		...
		result.setMemberships(JsonInput.getListOrEmpty(content, "memberships", MEMBERSHIP_PARSER));
		result.setGroups(JsonInput.getListOrEmpty(content, "groups", GROUP_PARSER));
