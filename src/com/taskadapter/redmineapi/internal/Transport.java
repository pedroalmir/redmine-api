...
public final class Transport {
	...
	static {
		...
		OBJECT_CONFIGS.put(
				IssueCategory.class,
				config("issue_category", "issue_categories", RedmineJSONBuilder.CATEGORY_WRITER,
		...
		OBJECT_CONFIGS.put(TimeEntry.class,
				config("time_entry", "time_entries", RedmineJSONBuilder.TIME_ENTRY_WRITER, RedmineJSONParser.TIME_ENTRY_PARSER));
		...
		OBJECT_CONFIGS.put(Membership.class,
				config("membership", "memberships", RedmineJSONBuilder.MEMBERSHIP_WRITER, RedmineJSONParser.MEMBERSHIP_PARSER));
		...
		OBJECT_CONFIGS.put(TimeEntryActivity.class,
				config("time_entry_activity", "time_entry_activities", null, RedmineJSONParser.TIME_ENTRY_ACTIVITY_PARSER));
	...
	public Transport(URIConfigurator configurator, RedmineOptions options) {
		...
		Communicator<String> coreCommunicator = Communicators.fmap(errorCheckingCommunicator, Communicators.contentReader());
		this.communicator = Communicators.simplify(coreCommunicator, Communicators.<String> identityHandler());
	}
	...
	private static <T> EntityConfig<T> config(String objectField, String urlPrefix, JsonObjectWriter<T> writer,
